...
public enum Op {
    ...
    private static final Map<Op, String> OPERATOR_MAP = new HashMap<>();

    //lua操作符
    static {
        OPERATOR_MAP.put(GreaterThenEquals, ">=");
        OPERATOR_MAP.put(GreaterThen, ">");
        OPERATOR_MAP.put(Equals, "==");
        OPERATOR_MAP.put(NotEquals, "!=");
        OPERATOR_MAP.put(LessThenEquals, "<=");
        OPERATOR_MAP.put(LessThen, "<");
    }

    public static String parse(Op op) {
